...
#  		 echo ${aname}
  		 curl --connect-timeout 10 -s -X GET -u 'readonly:readonly' https://api.a2rm.direct.tpicapcloud.com/application_instances?name=${aname} | python -m json.tool > ${ATMP}
...
#				echo ${parname}
  		 		curl --connect-timeout 10 -s -X GET -u 'readonly:readonly' https://api.a2rm.direct.tpicapcloud.com/application?name=${parname} | python -m json.tool > ${APTMP}
				$CRIT_CMD
				if [ $? -eq 0 ]
		       		 	then
