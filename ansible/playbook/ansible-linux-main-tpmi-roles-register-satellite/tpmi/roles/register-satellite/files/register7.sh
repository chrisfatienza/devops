...
# Activation keys: [BLANK-KEY,ACT-RHEL7-PROD-P]
...
register_host() {
  curl --silent --show-error --cacert $SSL_CA_CERT --request POST https://ldn2lx1000/register \
       -H 'Authorization: Bearer eyJhbGciOiJIUzI1NiJ9.eyJ1c2VyX2lkIjo5LCJpYXQiOjE2NjgwNzA0MDIsImp0aSI6IjE1YTljZmNkMTU2OTdlYWE2MjNiMDM2NDFhODk1OGRjMzhhMDI4YTliZGE3MGYwMmEwZjZkZjYwODgyZWNjZTUiLCJleHAiOjE2NjgwODQ4MDIsInNjb3BlIjoicmVnaXN0cmF0aW9uI2dsb2JhbCByZWdpc3RyYXRpb24jaG9zdCJ9.C56RFzrdFNSzTi1CjSELzXxEOR_g6ab--lKhATud1Yc' \
       ...
       --data 'host[operatingsystem_id]=1' \
...
if [ -f /etc/redhat-release ]; then
    ...
    subscription-manager register --force \
      --org='TPICAP' \
      --activationkey='BLANK-KEY,ACT-RHEL7-PROD-P' || true
